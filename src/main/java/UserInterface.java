...
public class UserInterface extends JFrame {
     ...
     */ 
    public UserInterface( Downloader downloader ) {
    ...
    private class ButtonEventListener implements ActionListener {
        ...
        public void actionPerformed( ActionEvent event ) {
            ...
            if ( event.getSource() == downloadButton ) {
                downloader.formalDownload( getLinkField.getText(), ENCODE_FORMATS[ formatBox.getSelectedIndex() ].substring( 2 ) );
                notification.setText( downloader.getDownloadSuccess() ? USER_MESSAGE_SUCCESS : USER_MESSAGE_FAILURE );
            }
        }
    }
}
